...
import { Package, Clock, CheckCircle, Truck, AlertCircle, ArrowLeft, MapPin, Phone, Calendar } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Для просмотра заказа необходимо авторизоваться
            </p>
            <Link href="/auth">
              <Button>Войти</Button>
            </Link>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex space-x-4">
            ...
            {order.status === 'delivered' && (
              <Link href={`/order/${order.id}/review`} className="flex-1">
